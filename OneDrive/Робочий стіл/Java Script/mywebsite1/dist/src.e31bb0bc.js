...
var model = exports.model = [new _blocks.TitleBlock('Курси IT', {
  tag: 'h2',
  styles: {
  ...
  alt: 'Це картинка'
}), new _blocks.ColumnsBlock(['Навчишся застосовувати CSS/HTML', 'Отримаєш навики Java Script', 'Також знання з React'], {
  styles: {
...
}), new _blocks.TextBlock('Тут багато інтересного матеріалу: <a href="#"> курси </a>', {
  styles: {
    color: 'hwb(210 64% 25%)',
    background: 'linear-gradient(to right, hwb(223 3% 62%), hwb(224 0% 89%))',
    padding: '1rem',
